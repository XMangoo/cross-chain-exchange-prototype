...
contract HomeBridge {
    ...
    function deposit(address token, address recipient, uint value, bytes32 transactionHash) public onlyAuthority() {
        // Protection from misbehaing authority
        var hash = keccak256(token, recipient, value, transactionHash);
